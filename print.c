...
/**
 * print_insigned - prints an unsigned num
 * @types: input
 * @buffer: input
 * @flags: input
 * @width: input
 ...
 */
int print_insigned(va_list types, char buffer[], int flags,
...
/**
 * print_octal - print an unsigned num is octal notation
 * @types: input
 * @buffer: input
 * @flags: input
 * @width: input
...
/**
 * print_hexadecimal - print an unsugned bnumber in hexa
 * @types: input
 * @buffer: input
 * @flags: input
 * @width: input
